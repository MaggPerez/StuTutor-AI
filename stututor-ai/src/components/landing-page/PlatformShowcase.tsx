...
const capabilities = [
  {
    icon: MessageSquare,
    title: 'AI Chat Tutor',
    description: 'Get instant, personalized explanations on any topic. Upload your lecture slides or PDFs and ask questions directly about your course material.',
    color: 'bg-primary',
  ...
  },
  {
    ...
    description: 'Reinforce your understanding with AI-generated quizzes. Enter any topic or upload a document and get a custom quiz in seconds.',
    color: 'bg-chart-2',
  ...
  },
  {
    ...
    description: 'Paste your notes or upload a PDF and let AI condense them into clear, concise summaries you can actually study from.',
    color: 'bg-chart-3',
  ...
  },
  {
    ...
    description: 'Your personalized command center with daily streaks, upcoming deadlines, and a snapshot of everything on your plate.',
    color: 'bg-chart-1',
  ...
  },
  {
    ...
    description: 'Never miss a deadline. Track assignments, due dates, and submission status across all your courses in one place.',
    color: 'bg-chart-4',
  ...
  },
  {
    ...
    description: 'Visualize all your assignments and deadlines in a clean weekly calendar view so you can plan your study sessions ahead of time.',
    color: 'bg-chart-5',
